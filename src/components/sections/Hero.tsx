      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Christian Andres
            <br />
            <span className="text-gradient">Rodriguez Cierpe</span>
          </h1>
          ...
          >
            IT Project Coordinator & Software Delivery Specialist
          </p>
          ...
          >
            10+ years coordinating software delivery in banking, public sector & automotive. 
            Strong in portfolio tracking, executive reporting, and cross-functional leadership.
          </p>
